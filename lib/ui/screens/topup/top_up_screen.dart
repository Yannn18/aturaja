      ...
      PaymentMethod(
        ...
        instructions: [
          InstructionStep(
            number: 1,
            text:
                'Masukkan kartu ATM dan PIN Anda dengan benar di mesin ATM BCA terdekat.',
          ),
          InstructionStep(
            number: 2,
            text:
          ...
          InstructionStep(
            number: 3,
            text:
                'Masukkan kode perusahaan AturAja (12345) diikuti nomor HP terdaftar Anda.',
            highlight: '(12345)',
          ),
          InstructionStep(
            number: 4,
            text:
                'Masukkan nominal top up yang Anda inginkan (Minimal Rp10.000).',
          ),
          InstructionStep(
            number: 5,
            text:
                'Ikuti instruksi selanjutnya pada layar ATM untuk menyelesaikan transaksi.',
          ),
        ],
      ),
      PaymentMethod(
        ...
        instructions: [
          ...
          InstructionStep(
            number: 2,
            text:
                'Informasikan kepada kasir bahwa Anda ingin melakukan Top Up AturAja.',
          ),
          InstructionStep(
            number: 3,
            text: 'Berikan nomor HP Anda kepada kasir.',
          ),
          InstructionStep(
            number: 4,
            text: 'Sebutkan nominal top up yang diinginkan.',
          ),
          InstructionStep(
            number: 5,
            text: 'Bayar sesuai nominal dan simpan struk pembayaran Anda.',
          ),
        ],
      ),
      PaymentMethod(
        ...
        instructions: [
          InstructionStep(
            number: 1,
            text: 'Kunjungi gerai Indomaret terdekat.',
          ),
          InstructionStep(
            number: 2,
            text:
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) =>
                    _buildMethodButton(_methods[index]),
              ),
            ),
            const SizedBox(height: 32),
      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                'Langkah Top Up ${_selectedMethod.name}',
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  // ========================================================
                  // TOMBOL SALIN (COPY) & TRIGGER SIMULASI TOP UP
                  // ========================================================
                  GestureDetector(
                    onTap: () {
                      // 1. Salin VA ke Clipboard HP
                      Clipboard.setData(
                        ClipboardData(text: _selectedMethod.va),
                      );

                      // 2. Tambahkan saldo simulasi sebesar Rp50.000 ke State Global
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text(
                            'VA disalin! Simulasi Top Up Rp50.000 berhasil masuk.',
                          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          // ========================================================
          // PENDENGAR PERUBAHAN SALDO GLOBAL (ValueListenableBuilder)
          // ========================================================
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Flexible(
            // Gunakan Flexible agar list di dalam modal bisa di-scroll
            child: ListView(
              shrinkWrap: true,
              children: _methods
                  .map(
