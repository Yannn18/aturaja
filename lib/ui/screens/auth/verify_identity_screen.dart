...
class _VerifyIdentityScreenState extends State<VerifyIdentityScreen> {
  ...
  // Format Nomor Telepon Dinamis (+62 812 •••• 889)
  String get _formattedPhone {
    ...
    final suffix = clean.length >= 3 ? clean.substring(clean.length - 3) : '889';
  ...
  void _handleOtpChange(String value, int index) {
    ...
    // Geser fokus ke kotak berikutnya
    if (index < _otpLength - 1) {
      _focusNodes[index + 1].requestFocus();
    }

    // Cek jika seluruh OTP 6 digit telah terisi penuh
    final finalCode = _otpValues.join('');
    if (finalCode.length == _otpLength && !_otpValues.contains('')) {
      FocusScope.of(context).unfocus(); // Sembunyikan keyboard numpad
...
Widget build(BuildContext context) {
  return Scaffold(
    ...
    body: Container(
      height: MediaQuery.of(context).size.height, // Mengunci tinggi kontainer sewarna gradien
      ...
      child: SafeArea(
        // 1. GUNAKAN SingleChildScrollView AGAR BEBAS OVERFLOW SAAT NUMPAD MUNCUL
        child: SingleChildScrollView(
          physics: const ClampingScrollPhysics(), // Menjaga guliran tetap tenang/tidak membal berlebihan
          ...
          child: Column(
            children: [
              ...
              // 3. MIDDLE INTERACTIVE OTP SLOTS SECTION
              const SizedBox(height: 48), // Mengganti MainAxisAlignment dengan Spacer manual yang adaptif
              Row(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            focusedBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(100),
                              borderSide: const BorderSide(color: Color(0xFFD31111), width: 2),
                            ),
                          ),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xFFD31111)),
                  ),
                ],
              ),
              const SizedBox(height: 8),
              TextButton(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.bold,
                    color: _secondsLeft > 0 ? const Color(0xFFE5E7EB) : const Color(0xFFD31111),
                  ),
                ),
              ),

              // 4. SECURITY ENCRYPTION CARD
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.shield_outlined, color: Color(0xFFD31111), size: 20),
                    ),
